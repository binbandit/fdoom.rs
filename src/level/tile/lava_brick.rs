//! Port of `fdoom.level.tile.LavaBrickTile`. TODO(port:tile): full port pending.
...
/// Java `LavaBrickTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str) -> TileDef {
    TileDef::new(name, TileKind::LavaBrick)
}
