//! Port of `fdoom.level.tile.GraveStoneTile`. TODO(port:tile): full port pending.
...
/// Java `GraveStoneTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str, broken:bool) -> TileDef {
    TileDef::new(name, TileKind::GraveStone { broken })
}
