//! Port of `fdoom.level.tile.SnowTreeTile`. TODO(port:tile): full port pending.
...
/// Java `SnowTreeTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str) -> TileDef {
    TileDef::new(name, TileKind::SnowTree)
}
