//! Port of `fdoom.level.tile.TallGrassTile`. TODO(port:tile): full port pending.
...
/// Java `TallGrassTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str, on_tile:&str, kind:i32) -> TileDef {
    TileDef::new(name, TileKind::TallGrass { kind })
}
