//! Port of `fdoom.level.tile.TreeTile`. TODO(port:tile): full port pending.
...
/// Java `TreeTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str) -> TileDef {
    TileDef::new(name, TileKind::Tree)
}
