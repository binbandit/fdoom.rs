//! Port of `fdoom.level.tile.DirtTile`. TODO(port:tile): full port pending.
...
/// Java `DirtTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str) -> TileDef {
    TileDef::new(name, TileKind::Dirt)
}
