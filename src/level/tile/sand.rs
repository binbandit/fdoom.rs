//! Port of `fdoom.level.tile.SandTile`. TODO(port:tile): full port pending.
...
/// Java `SandTile` constructor — sprite/config TODO(port:tile).
#[allow(unused_variables)]
pub fn make(name:&str) -> TileDef {
    TileDef::new(name, TileKind::Sand)
}
